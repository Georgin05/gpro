...
/* Mobile Styles – inherit the same color logic */
            ...
            <div class="charts-container">
                <div class="chart-card">
                    ...
                    <div class="chart-placeholder">
                        <i class="fas fa-chart-line pulse" style="font-size: 2rem;"></i>
                        <span style="margin-left: 10px;">Inventory movement chart</span>
                    </div>
                </div>
                ...
                <div class="chart-card">
                    ...
                    <div class="chart-placeholder">
                        <i class="fas fa-chart-pie pulse" style="font-size: 2rem;"></i>
                        <span style="margin-left: 10px;">Storage utilization chart</span>
                    </div>
                </div>
            </div>
                ...
                <ul class="activity-list">
                    <li class="activity-item">
                        ...
                        <div class="activity-content">
                            <h4>Order #1042 shipped</h4>
                            <p>3 items shipped to customer</p>
                        </div>
                    ...
                    <li class="activity-item">
                        ...
                        <div class="activity-content">
                            <h4>Receipt #421 received</h4>
                            <p>15 items received from supplier</p>
                        </div>
                    ...
                    <li class="activity-item">
                        ...
                        <div class="activity-content">
                            ...
                            <p>Product #A42-56 below threshold</p>
                        </div>
                    ...
                    <li class="activity-item">
                        ...
                        <div class="activity-content">
                            ...
                            <p>Warehouse operator account created</p>
                        </div>
